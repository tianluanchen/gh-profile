...
import LngSelect from "./LngSelect.vue";
...
<template>
    <n-layout-header class="nav" style="height: 64px" bordered>
        <n-space align="center" justify="space-between" style="width: 100%">
            <n-space align="center" justify="center" style="height: 100%" size="small">
                <n-button
                    href="https://github.com/tianluanchen/gh-profile"
                    target="_blank"
                    tag="a"
                    text
                    type="primary"
